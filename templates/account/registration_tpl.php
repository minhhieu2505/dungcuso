<div class="wrap-user wrap-chill">
        ...
        <form action="" method="post" class="register-form">
            ...
            <label class="label" for="name">Tên tài khoản *</label>
                <input type="text" class="form-control text-sm" id="username" name="username" placeholder="">
            ...
            <label class="label" for="name">Mật khẩu (Tối thiểu 6 ký tự) *</label>
                <input type="password" class="form-control text-sm" id="password" name="password" pattern=".{6,}" placeholder="">
                    <div class="invalid-feedback">Vui lòng nhập mật khẩu</div> 
            </div>
            <div class="form-group mb-3">
            <label class="label" for="name">Nhập lại mật khẩu (Tối thiểu 6 ký tự) *</label>
                <input type="password" class="form-control text-sm" id="repassword" name="repassword" pattern=".{6,}" placeholder="">
                    <div class="invalid-feedback">Vui lòng nhập mật khẩu</div> 
            </div>
            <div class="form-group mb-3">
            <label class="label" for="name">HỌ TÊN *</label>
                <input type="text" class="form-control text-sm" id="fullname" name="fullname" placeholder="">
                    <div class="invalid-feedback">Vui lòng nhập họ tên</div> 
            </div>

            <div class="form-group mb-3">
            <label class="label" for="name">SỐ ĐIỆN THOẠI *</label>
                <input type="number" class="form-control text-sm" id="phone" name="phone" placeholder="">
                    <div class="invalid-feedback">Vui lòng nhập số điện thoại</div> 
            </div>
            <div class="form-group mb-3">
            <label class="label" for="name">ĐỊA CHỈ *</label>
                <input type="text" class="form-control text-sm" id="address" name="address" placeholder="">
