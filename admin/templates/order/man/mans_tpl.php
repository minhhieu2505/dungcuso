            ...
            <tbody>
               ...
               <tr>
                  <td class="align-middle">
                     <input type="number" class="form-control form-control-mini m-auto update-numb" min="0" value="<?=$i+1?>">
                  </td>
                  <td class="align-middle">
                  ...
                  <td class="align-middle text-center text-md text-nowrap">
                     ...
                     <a class="mr-2 btn btn-primary me-2" href="index.php?source=excel&id=<?= $items[$i]['id'] ?>" title="Chỉnh sửa"><i class="fas fa-file-excel"></i></a>
